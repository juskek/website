...
<ImageAtom src="/static/blog/flutter-vs-react-native/3-as-a-cto/images/radar.gif" altText="Radar chart animation" caption="Flutter provides a framework to create code-based animations like in d3js" source="https://medium.com/geekculture/how-to-create-a-custom-staggered-animation-with-flutter-13803dea5659"/>
