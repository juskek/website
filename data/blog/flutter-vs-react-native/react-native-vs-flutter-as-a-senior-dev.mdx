...
![Alt text](/static/blog/flutter-vs-react-native/2-as-a-senior-dev/images/image.png)
...
<figure>
<img src="/static/blog/flutter-vs-react-native/2-as-a-senior-dev/images/image-1.png" alt="my alt text"/>
<figcaption style={{ textAlign: 'center', fontSize: 'smaller' }}>

An example of Dependency Injection in Flutter using injectable, where a roomId (dependency) is resolved to a getter or constant depending on whether env is set to prod or test.
</figcaption>
</figure>
...
<figure>
<img src="/static/blog/flutter-vs-react-native/2-as-a-senior-dev/images/image-2.png" alt="my alt text"/>
<figcaption style={{ textAlign: 'center', fontSize: 'smaller' }}>

Testing is easier to set up in Flutter
</figcaption>
</figure>
...
<figure>
  <img src="/static/blog/flutter-vs-react-native/2-as-a-senior-dev/images/e2e.gif" alt="my alt text"/>
  <figcaption style={{ textAlign: 'center', fontSize: 'smaller' }}>
